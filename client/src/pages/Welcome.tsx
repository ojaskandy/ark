    ...
    <div className="min-h-screen bg-rose-50/30 overflow-x-hidden">
      ...
      >
        ...
        <motion.button
          ...
          className="px-5 py-2 text-sm text-gray-600 hover:text-gray-800 transition-colors rounded-full border border-gray-300/50 hover:border-gray-400/50 bg-white/40 backdrop-blur-sm"
